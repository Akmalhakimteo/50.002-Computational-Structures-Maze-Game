...
module multi_dec_ctr_3 (
  ...
  reg [(2'h2+0)-1:0] M_dctr_dnc;
  
  genvar GEN_dctr0;
  generate
  for (GEN_dctr0=0;GEN_dctr0<2'h2;GEN_dctr0=GEN_dctr0+1) begin: dctr_gen_0
    decimal_counter_21 dctr (
      .clk(clk),
      .rst(rst),
      .dnc(M_dctr_dnc[GEN_dctr0*(1)+(1)-1-:(1)]),
  ...
  always @* begin
    M_dctr_dnc[0+0-:1] = dnc;
    digits = M_dctr_value;
    M_dctr_dnc[1+0-:1] = M_dctr_ovf[0+0-:1];
  end
endmodule
